...
const tripApiQuery = (q) =>{
  return axios.get(`https://api.tripadvisor.com/api/partner/2.0/location/48739/${q}?key=39da9761-5995-4fff-847b-bd49a0e08b8a`)
  .then((res)=>{
    return res.data.data.map((e)=>{
      let restaurantInfo = {
        'name': e.name,
